...
This purchase order authorizes Northwest Industrial Components, LLC to provide stainless-steel isolation valves for use in a simulated DOE nuclear-related project supported by Columbia Basin Technical Services.
...
- Be manufactured from the specified stainless-steel material.
...
- Maintain traceability for materials used in the supplied components.
- Perform final inspection before shipment.
- Provide documentation demonstrating completion of required inspection activities.
...
CBTS will verify the shipment before acceptance by reviewing:

- Item identity and quantity
- Visible condition
- Conformance with purchase-order requirements
